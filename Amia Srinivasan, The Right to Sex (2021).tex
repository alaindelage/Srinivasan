...
\begin{quote}
	the feminists who have long demanded that we \textbf{see sex}, as we know it, not as some primordial, pre-political given, but \textbf{as an effect of politics, all too easily and falsely naturalise}d.\\[1ex] 
...
\begin{quote}
	Rich’s point is that heterosexuality is a political i tution that compels even ‘straight’ women --- through its psychic internalisation, yes, but also through its violent enforcement --- to regulate their intimacies, affinities and relations in ways that often betray what it is they really want. [\dots\hspace{-0.3ex}]\\[1ex]
	Rich’s point is that heterosexuality is a political i tution that compels even ‘straight’ women --- through its psychic internalisation, yes, but also through its violent enforcement --- to regulate their intimacies, affinities and relations in ways that often betray what it is they really want. 97
\end{quote}
\vskip 2ex
...
\begin{quote}
	In \emph{Ambiguity and Sexuality}, William Wilkerson writes: ‘Even though we think that our feelings were always there before coming out, we forget, in the very process of this remembering, that our memory reconstructs the previous feelings in light of what they become.’ (p. 49) 99
\end{quote}
\vskip 2ex
